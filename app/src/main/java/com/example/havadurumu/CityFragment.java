...
public class CityFragment extends Fragment {
    ...
    TextView txt_city_name,txt_humidity,txt_sunrise,txt_sunset,txt_pressure,txt_temperature,txt_description,txt_date_time,txt_wind_speed,txt_wind_dir,txt_geo_coords;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_fav = (ImageButton) itemView.findViewById(R.id.btn_fav);
        ...
        txt_wind_dir = (TextView) itemView.findViewById(R.id.txt_wind_dir);
        ...
        compositeDisposable.add(mService.getWeatherByCityName(cityName,
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_wind_speed.setText(new StringBuilder(String.valueOf(weatherResult.getWind().getSpeed())).toString());
                        txt_wind_dir.setText(new StringBuilder(String.valueOf(weatherResult.getWind().getDirection())).toString());
